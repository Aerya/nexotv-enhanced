...
4. Cocher les catégories voulues, puis choisir **Single catalog** ou **One catalog per category**.
...
- Nouveaux champs de configuration : `selectedCategories: string[]` et `catalogMode: 'single' | 'split'`.
